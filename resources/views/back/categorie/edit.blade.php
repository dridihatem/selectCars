          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Modifier le catégorie {{ $titleSeo}}</h3>
              </div>
              ...
              @if(session()->get('success'))
                ...
                @endif
            <form name="update" method="POST" action="{{ route('admin.list_categories.update',$categorie->id)}}"  enctype="multipart/form-data">
            {{method_field('post')}}
        {{csrf_field()}}
            ...
            <div class="row">
                ...
                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="status" value="1" name="status" {{ $categorie->status ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="titre" placeholder="" name="titre"  value="{{$categorie->titre}}">
                                 @error('titre')
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <a href="{{route('admin.categories.deleteimage',$categorie->id)}}">Supprimer l'image</a>
                  </div>
                  @endif

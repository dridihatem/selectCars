            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="{{route('admin.list_categories.add')}}" class="btn btn-sm btn-default">Ajouter une catégorie</a>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.list_categories') }}",
        columns: [
            {data: 'id', name: 'id'},
            {data: 'titre', name: 'titre'},
            {data: 'image', name: 'image',
                render: function( data, type, full, meta ) {
                        return "<img src=\"../images/categories/" + data + "\" class=\"img-rounded\" height=\"50\"/>";
                    }
                },
                {data:'status', name:'status',
                  render: function(data,type,full,meta){
                  if(data==1){
                return '<span class="badge bg-success">Publier</span>';
              }
              else {
                return '<span class="badge bg-warning">Ne pas publier</span>';
              }
            }
                },

          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Modifier FAQ</h3>
              </div>
              ...
              @if(session()->get('success'))
                ...
                @endif
            <form name="update" method="POST" action="{{ route('admin.list_faq.update',$faq->id)}}"  enctype="multipart/form-data">
            {{method_field('post')}}
        {{csrf_field()}}
            ...
            <div class="row">
                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="question" placeholder="" name="question"  value="{{$faq->question}}">
                                 @error('question')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="" id="reponse" name="reponse">{{$faq->reponse}}</textarea>
                                @error('reponse')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>

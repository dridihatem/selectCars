...
@section('content')
 ...
 <div class="page-title-area pb-100 bg-img bg-s-cover" data-bg-image="{{asset('assets/front/images/page-title-bg-4.jpg')}}">
        <div class="container">
            <div class="content">
                <h2>{{ $categorieTitre }}</h2>
                <ul class="list-unstyled">
                    <li class="d-inline"><a href="{{ url('/')}}">Accueil</a></li>
                    <li class="d-inline">/</li>
                    <li class="d-inline"><a href="{{ url('/categorie')}}">Catégorie</a></li>
                    <li class="d-inline">/</li>
                    <li class="d-inline active opacity-75">{{ $categorieTitre }}</li>
                </ul>
            </div>
        </div>
    </div>
...
@foreach ($voiture as $listVoiture )
<div class="col-xl-4 col-md-6" data-aos="fade-up">
                            <div class="product-default border p-10 mb-25">
                                ...
                                <div class="product-details">
                                    <span class="product-category font-xsm">{{ $marque->titre}}</span>

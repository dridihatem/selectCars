!(function($) {
    ...
    for (let i = 0; i < sliders.length; i++) {
        ...
        noUiSlider.create(el, {
            ...
            $('#min_value').val(values[0]);
            $('#max_value').val(values[1]);
        })
    }
    // Filter frice slider
    if (filterSliders) {
    ...
    var marque = new Swiper(".marque-slider", {
        speed: 400,
        spaceBetween: 40,
        loop: true,
        slidesPerView: 7,
        ...
        // Navigation arrows
        navigation: {
            nextEl: "#marque-slider-2-next",
            prevEl: "#marque-slider-2-prev",
        },
    ...
    var swiper = new Swiper(".shop-slider", {
     ...
     var swiper = new Swiper(".content-slider", {
        ...
        pagination: {
            el: '#content-slider-1-pagination',
            clickable: false,
            renderBullet: function(index, className) {
                return '<span class="' + className + '">' + "0" + (index + 1) + "</span>";
            },
